// lib/core/services/attraction_export_service.dart
...
const _kPdfColWidths = <int, pw.TableColumnWidth>{
  0: pw.FlexColumnWidth(2.4), // Attraction Name
  1: pw.FlexColumnWidth(2.4), // Attraction Type(s)
  2: pw.FlexColumnWidth(2.2), // Street
  3: pw.FlexColumnWidth(1.6), // Barangay
  4: pw.FlexColumnWidth(1.8), // Incharge Name
  5: pw.FlexColumnWidth(1.6), // Phone
};

// ─── Export service ───────────────────────────────────────────────────────────

class AttractionExportService {
  const AttractionExportService._();

  static List<String> _rowOf(AttractionExportRow r) => [
        r.attractionName,
        r.attractionTypes,
        r.street,
        r.barangay,
  ...
  static Future<void> exportToExcel(
    List<AttractionExportRow> data,
    BuildContext context,
  ) async {
    try {
      final excel = Excel.createExcel();
      excel.rename('Sheet1', 'Attractions');
      final sheet = excel['Attractions'];
